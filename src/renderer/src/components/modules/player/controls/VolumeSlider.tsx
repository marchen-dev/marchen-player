...
export const VolumeSlider = ({
  ...
  return (
    <div
      ...
      className={`no-drag-region group relative flex h-8 w-16 cursor-default touch-none items-center outline-none focus-visible:[&_[data-volume-track]]:ring-2 focus-visible:[&_[data-volume-track]]:ring-[var(--player-focus)] ${className ?? ''}`}
